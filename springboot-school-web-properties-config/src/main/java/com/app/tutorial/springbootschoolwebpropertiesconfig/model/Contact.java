package com.app.tutorial.springbootschoolwebpropertiesconfig.model;
...
@NamedQueries({
    ...
    @NamedQuery(name = "Contact.updateMsgStatus", query = "UPDATE Contact c SET c.status=?1 WHERE c.id=?2")
})
@NamedNativeQueries({
